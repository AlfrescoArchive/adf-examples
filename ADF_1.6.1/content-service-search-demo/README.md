# Content Service Search demo (ADF 1.6.1 example)
...
This project implements a search component from Alfresco Content Services that is requested to be avaialble.
