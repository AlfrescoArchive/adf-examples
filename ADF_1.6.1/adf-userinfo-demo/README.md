# UserInfo demo (ADF 1.6.1 example)
...
This project implements an very simple login page managing the presentation of the user details coming from Alfresco Content Services and/or Alfresco Process Services.
...
![Alfresco Content Services user info](doc/screenshot.01.png)
![Alfresco Process Services user info](doc/screenshot.02.png)
