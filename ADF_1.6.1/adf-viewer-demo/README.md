# Content viewer demo (ADF 1.6.1 example)
...
This project implements a content viewer from Alfresco Content Services that is requested to be avaialble.
...
![Alfresco Content Services viewer sample](doc/screenshot.01.png)
![Alfresco Content Services viewer home](doc/screenshot.02.png)
