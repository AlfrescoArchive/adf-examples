# Process Services Diagrams demo (ADF 1.6.1 example)
...
This project implements the diagrams component from Alfresco Process Services, that is requested to be avaialble.
