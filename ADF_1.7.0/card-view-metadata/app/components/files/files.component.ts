...
import { AlfrescoApiService, AlfrescoContentService,
    CardViewItem, CardViewTextItemModel, FileUploadCompleteEvent, FolderCreatedEvent, NotificationService, SiteModel, UploadService } from 'ng2-alfresco-core';
...
export class FilesComponent implements OnInit {
    ...
    onNodeClick(event) {
        ...
        this.metadataConvert(event.value.entry);
    }

    metadataConvert(node: MinimalNode) {
        this.metadata = [];
