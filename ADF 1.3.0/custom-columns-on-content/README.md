# Custom columns on content (ADF 1.3.0 example)
...
This project implements an [Alfresco ADF](https://github.com/Alfresco/alfresco-ng2-components) application, managing custom columns on a document list component.
...
- Once accessed to the application, you can dive into the repository using the document list and check for the view on some simpkle and complex columns.
...
![Custom columns](public/img/screenshot.2.png)

![Menu](public/img/screenshot.3.png)

![Help](public/img/screenshot.4.png)
